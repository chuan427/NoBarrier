...
@Validated
@RequestMapping("/que")
public class QueUseridController {
	...
	public String getOne_For_Display(
		...
		@Digits(integer = 4, fraction = 0, message = "消息編號: 請填數字-請勿超過{integer}位數")
...
//		NewsService newsSvc = new NewsService();
		...
		model.addAttribute("queListData", list); // for select_page.html 第97 109行用
...
//		return "back-end//listOne";  // 查詢完成後轉交listOne.html
		return "back-end/que/select_page"; // 查詢完成後轉交select_page.html由其第128行insert listOne.html內的th:fragment="listOne-div
	}
...
//    	Service Svc = new Service();
	    ...
	    return new ModelAndView("back-end/que/select_page", "errorMessage", "請修正以下錯誤:<br>"+message);
	}
